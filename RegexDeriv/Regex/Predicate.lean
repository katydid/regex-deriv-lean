...
example : Predicate.eval isLowerCase 'A' = false := by simp [Predicate.eval] <;> decide
example : Predicate.eval isLowerCase 'a' = true := by simp [Predicate.eval] <;> native_decide
example : Predicate.eval isLowerCase 'l' = true := by simp [Predicate.eval] <;> native_decide
